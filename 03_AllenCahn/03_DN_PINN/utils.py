...
def plot_gamma_curve(
    ...
    plt.figure(figsize=(8, 4))
    plt.plot(epoch_log, gamma_ic_log,  alpha=.7, ls="-",  label="gamma_ic",  c="tab:orange")
    plt.plot(epoch_log, gamma_bc1_log, alpha=.7, ls="-",  label="gamma_bc1", c="tab:green")
    plt.plot(epoch_log, gamma_bc2_log, alpha=.7, ls="--", label="gamma_bc2", c="tab:green")
    plt.legend(loc="upper right")
    plt.grid(alpha=.5)
    plt.tight_layout()
